...
import { User, Phone, Mail, MapPin, Briefcase, Calendar, AlertTriangle, Stethoscope } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 mt-0.5">View the details of your assigned primary care doctor.</p>
          </div>
        </div>
